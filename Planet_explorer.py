...
def home_screen(planets):
    ...
    y = 350  # Vertical position for thumbnails
    ...
    while True:
        ...
        screen.blit(frame_surface, (1, 0)) # Dark blue background
        ...
        instr_rect = instr_surf.get_rect(center=(600, 170))
